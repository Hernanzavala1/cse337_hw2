...
player.sense(:bats) {puts "You hear a rustling"}
player.sense(:guard) {puts "You smell something terrible"}
player.encounter(:guard) {puts "The guard killed you"}
player.encounter(:bats) { puts "The bats whisked you away"}
